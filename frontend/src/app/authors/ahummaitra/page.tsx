  ...
  return (
    <>
      <div className="w-full min-h-screen p-3 flex flex-col justify-center items-center gap-10">
        ...
        <p className="font-semibold italic border-b-cyan-400 p-3 rounded-2xl border-4">Hello, World! I'm a programmer, who loves Python, JS, TS, Web development Frontend, Backend, Go, Rust!</p>
